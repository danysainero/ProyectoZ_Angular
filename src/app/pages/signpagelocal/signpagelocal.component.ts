...
@Component({
  selector: 'app-signpagelocal',
  templateUrl: './signpagelocal.component.html',
  styleUrls: ['./signpagelocal.component.scss']
})
export class SignpagelocalComponent implements OnInit {
